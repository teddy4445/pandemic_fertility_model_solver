...
class SimulationGenerator:
    ...
    def generate(model_parameter_average,
        ...
        city_data = SimulationGenerator.get_cities_data()[city_initial_condition]
        if is_control_case:
            params["beta"] = 0
    ...
    def get_parameters_mean():
        parameters = {
            ...
            "omega": (0.05661 + 0.06919) / 2 / 365,  # Average of range
    ...
    def get_parameters_sampled():
        parameters = {
            ...
            "alpha_ae": 1.10e-4,  # Single value
            "alpha_ed": 7.94e-5,  # Single value
            "omega": random.uniform(0.05661 / 365, 0.06919 / 365),  # Uniform sampling
